 ...
 * @property Doctrine_Collection $Playlist
 ...
 * @method Doctrine_Collection   getPlaylist()              Returns the current record's "Playlist" collection
 ...
 * @method sfGuardUser           setPlaylist()              Sets the current record's "Playlist" collection
 * @method sfGuardUser           setAlbumsUsers()           Sets the current record's "AlbumsUsers" collection
 * 
 * @package    sonor
 * @subpackage model
